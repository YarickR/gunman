    ...
    SubShader {
        ...
        Pass {
			...
			v2f vert(appdata v)
			{
				...
				o.preMulAlphaColor_vertexAlpha.rgb = v.color.rgb * v.color.a * _ColorMul;
				o.texcoord_alphaBlendFactor.z = saturate(max(max(v.color.r, v.color.g), v.color.b) * _ColorMul - 1.0f); // 0 = alphablend, 1 = additive blend
