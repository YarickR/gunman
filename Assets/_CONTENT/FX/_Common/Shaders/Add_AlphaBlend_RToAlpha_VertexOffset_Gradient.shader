...
Shader "FX/_Common/Add_AlphaBlend_RToAlpha_VertexOffset_Gradient" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
			...
			fixed4 frag(v2f i) : COLOR
			{
				...
				float3 upperGradientColor = lerp(_MidColor.rgb, _Color.rgb * 2.0f, (mask - _MiddleColorPos) / (1.0f - _MiddleColorPos) );
